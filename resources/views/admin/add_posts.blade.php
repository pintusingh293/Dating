...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Add Posts</a> </div>
        <h1>Add Posts</h1>
    </div>
    ...
    <div class="container-fluid">
        <form class="form-horizontal" method="POST" action="/admin/add_posts" id="postform" enctype="multipart/form-data">
            @csrf
